...
public class UserAssignmentControllerTest {
    ...
    public void testCreate() throws Exception {
        when(userAssignmentService.create(userAssignmentDTO1)).thenReturn(userAssignmentDTO1);
        ...
        verify(userAssignmentService).create(any(UserAssignmentDTO.class));
        assertEquals(objectMapper.writeValueAsString(userAssignmentDTO1), mvcResult.getResponse().getContentAsString());
    }

    @Test
    public void testReadById() throws Exception {
        when(userAssignmentService.readById(ID_2)).thenReturn(userAssignmentDTO2);
        ...
        verify(userAssignmentService).readById(anyLong());
    ...
    @Test
    public void testGetByAssignment() throws Exception {
        when(userAssignmentService.getByAssignment(MATERIAL_ID)).thenReturn(Arrays.asList(userAssignmentDTO1, userAssignmentDTO2));
        ...
        verify(userAssignmentService).getByAssignment(anyLong());
