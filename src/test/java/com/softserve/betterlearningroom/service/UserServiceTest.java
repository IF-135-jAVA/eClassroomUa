...
class UserServiceTest {
    ...
    void whenUserIdIsProvided_thenReturnCorrectUser() {
        User user = new User(USER_ID, USER_FIRSTNAME, USER_LASTNAME, USER_PASSWORD, USER_EMAIL, USER_ENABLED,
                USER_ENABLED, USER_PROVIDER, USER_PROVIDER_ID);
    ...
    void whenGetAllUsers_thenReturnCorrectList() {
        ...
        userList.add(new User(USER_ID, USER_FIRSTNAME, USER_LASTNAME, USER_PASSWORD, USER_EMAIL, USER_ENABLED, USER_ENABLED,
                USER_PROVIDER, USER_PROVIDER_ID));
        userList.add(new User(2L, "Yurii", "Kotsiuba", USER_PASSWORD, "jurok3x@gmail.com", USER_ENABLED, USER_ENABLED, USER_PROVIDER,
                USER_PROVIDER_ID));
        userList.add(new User(3l, "Bob", "Smith", USER_PASSWORD, "bob@gmail.com", USER_ENABLED, USER_ENABLED, USER_PROVIDER,
                USER_PROVIDER_ID));
        userList.add(new User(4l, "John", "Doe", USER_PASSWORD, "jdoe@gmail.com", USER_ENABLED, USER_ENABLED, USER_PROVIDER,
                USER_PROVIDER_ID));
