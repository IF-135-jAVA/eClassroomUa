...
public enum Roles {
    ...
    TEACHER("teacher", Arrays.asList(ASSIGNMENT_READ, ASSIGNMENT_WRITE, USER_READ, USER_WRITE, CLASSROOM_READ,
            CLASSROOM_WRITE, TOPIC_READ, TOPIC_WRITE, USER_ASSIGNMENT_READ, USER_ASSIGNMENT_WRITE,
            COMMENT_READ, COMMENT_WRITE, CRITERION_READ, CRITERION_WRITE, LEVEL_READ, LEVEL_WRITE).stream().collect(Collectors.toSet())),
    STUDENT("student", Arrays.asList(ASSIGNMENT_READ, ASSIGNMENT_WRITE, USER_READ, USER_WRITE, CLASSROOM_READ,
            TOPIC_READ, USER_ASSIGNMENT_READ, USER_ASSIGNMENT_WRITE, COMMENT_READ, COMMENT_WRITE,
