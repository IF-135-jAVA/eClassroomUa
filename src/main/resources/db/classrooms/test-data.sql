...
INSERT INTO classrooms( user_id, title, description, code)
VALUES ( 12, 'Mathematics', 'General and overarching topics collections: Introductory exposition pertaining to mathematics in general', '9e8gh1t');
INSERT INTO classrooms( user_id, title, description, code)
VALUES ( 13, 'Biology', 'Genetics, Genomes, Chromosomes and the Cell Cycle', 'r4f6v1t');