...
MERGE INTO classrooms(classroom_id, user_id, title, description, code)
VALUES (3, 4, 'Mathematics', 'General and overarching topics collections: Introductory exposition pertaining to mathematics in general', '9e8gh1t');
MERGE INTO classrooms(classroom_id, user_id, title, description, code)
VALUES (4, 3, 'Biology', 'Genetics, Genomes, Chromosomes and the Cell Cycle', 'r4f6v1t');